...
class CurriculumDomainRandomizer(DomainRandomizer):
    ...
    def __init__(
        self,
        seed: int | None = None,
        wind_speed_kn_start: Tuple[float, float] = (0.0, 4.0),
        wind_speed_kn_end: Tuple[float, float] = (4.0, 15.0),
        current_speed_kn_start: Tuple[float, float] = (0.0, 0.5),
        current_speed_kn_end: Tuple[float, float] = (0.5, 3.0),
        wave_height_m_start: Tuple[float, float] = (0.0, 0.5),
        wave_height_m_end: Tuple[float, float] = (0.5, 3.0),
        wind_dir_deg: Sequence[float] = (0.0, 45.0, 90.0, 135.0),
        current_dir_deg: Sequence[float] = (0.0, 45.0, 90.0, 135.0),
        wave_dir_deg: Sequence[float] = (0.0, 45.0, 90.0, 135.0),
        wave_period_s: float = 8.0,
...
class LDRDomainRandomizer(DomainRandomizer):
    ...
    def __init__(self, seed: int | None = None) -> None:
        super().__init__(
            seed=seed,
            wind_speed_kn=(5.0, 14.0),
            wind_dir_deg=(0.0, 45.0, 90.0, 135.0),
            current_speed_kn=(1.5, 2.5),
            current_dir_deg=(0.0, 45.0, 90.0, 135.0),
            wave_height_m=(1.5, 2.5),
...
class HDRDomainRandomizer(DomainRandomizer):
    ...
    def __init__(self, seed: int | None = None) -> None:
        super().__init__(
            seed=seed,
            wind_speed_kn=(12.0, 15.0),
            wind_dir_deg=(0.0, 45.0, 90.0, 135.0),
            current_speed_kn=(2.5, 3.0),
            current_dir_deg=(0.0, 45.0, 90.0, 135.0),
            wave_height_m=(2.5, 3.0),
            wave_dir_deg=(0.0, 45.0, 90.0, 135.0),
            wave_period_s=8.0,
            wave_phase_rad=0.0,
        )
